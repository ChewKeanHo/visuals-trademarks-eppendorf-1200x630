# Eppendorf Trademarks Logo 1200x630 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x630.svg)](#)

The Eppendorf Trademarks Logo. They owned a large number of trademark but did
not publish any trademark guideline left alone supplying the material files for
the universal trademark. The preferred version is `.svg` which has
non-destructive scale up & down properties and can be converted into any
rasterized images (e.g. `jpeg`, `webp`, `avif`, etc). Hence, a re-draw is
required.

This project re-draws Eppendorf Trademarks Logo specifically for 1200x630 size.
...
Since Eppendorf did not publish any trademark guideline, **it is assumed
standard trademarks laws applied to avoid any unwanted legal implications**.

While not specified by Eppendorf, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: Eppendorf Trademarks Logo 1200x630
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-eppendorf-1200x630
UUID: C39A936D-3394-41D7-8E15-308E16A71FBA
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-01-31
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-eppendorf-1200x630
--------------------------------------------------------------------------------
```
...
> COMPLY WITH EPPENDORF TRADEMARK REQUIREMENTS**.
>
